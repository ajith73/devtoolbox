...
export function JsFormatterTool() {
    const [input, setInput] = usePersistentState('js_formatter_input', '')
    const [output, setOutput] = usePersistentState('js_formatter_output', '')
    ...
    return (
        <ToolLayout
            ...
            description="Format JavaScript using Prettier (runs locally)."
            icon={FileCode}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="glass rounded-2xl border-[var(--border-primary)] p-5 bg-[var(--bg-secondary)]/30 md:col-span-2">
                        ...
                        <textarea
                            ...
                            placeholder="function x(){return 1}"
                        />
                    </div>
