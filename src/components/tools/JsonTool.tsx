...
export function JsonTool() {
    ...
    const handleDownload = () => {
        ...
        a.href = url
        a.download = 'devbox-formatted.json'
        a.click()
    ...
    return (
        <ToolLayout
            ...
            description="Validate and format your JSON strings with ease."
            icon={Braces}
                    ...
                    <div className="flex items-center justify-between px-4">
                        ...
                        {input && (
                            <div className={cn(
                                ...
                                <span className="tracking-[0.1em]">{error ? 'Syntax Violation' : 'Semantic Integrity Verified'}</span>
                            </div>
                        )}
                    </div>
                        ...
                        {error ? (
                            <div className="absolute inset-0 p-10 text-red-500/80 font-mono text-sm overflow-auto custom-scrollbar">
                                <div className="flex items-center space-x-3 mb-6 p-4 bg-red-500/5 border border-red-500/10 rounded-2xl">
                                    ...
                                    <p className="font-black uppercase tracking-widest text-[10px]">Logical Parsing Disruption</p>
                                </div>
