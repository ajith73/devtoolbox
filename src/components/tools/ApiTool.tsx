                        ...
                        <div className="space-y-6 flex flex-col">
                            ...
                            {['POST', 'PUT', 'PATCH'].includes(method) && (
                                <div className="space-y-3 flex-1 flex flex-col min-h-[250px] group">
                                    <label className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-[0.3em] pl-2 transition-colors group-focus-within:text-brand">Request Body (JSON)</label>
                                    <textarea
                        ...
                        <div className="space-y-3 flex flex-col">
                            ...
                            <div className="flex-1 relative glass rounded-[2.5rem] overflow-hidden border-[var(--border-primary)] min-h-[400px] bg-[var(--input-bg)] shadow-inner">
                                <pre className={cn(
                                    ...
                                    {response || <span className="text-[var(--text-muted)] opacity-30 italic">Hit send to see the response payload...</span>}
                                </pre>
                            </div>
                        </div>
                    </div>
