...
var i = function(r2) {
  var n2 = r2.h, u2 = r2.w, e2 = r2.b, b2 = r2.a, i2 = void 0 === b2 ? 1 : b2;
  if (!t(n2) || !t(u2) || !t(e2)) return null;
...
var d = function(t2) {
  var n2 = h.exec(t2);
  if (!n2) return null;
  var u2, e2, b2 = a({ h: (u2 = n2[1], e2 = n2[2], void 0 === e2 && (e2 = "deg"), Number(u2) * (r[e2] || 1)), w: Number(n2[3]), b: Number(n2[4]), a: void 0 === n2[5] ? 1 : Number(n2[5]) / (n2[6] ? 100 : 1) });
  return o(b2);
};
function hwb_default(r2, t2) {
...
export {
  hwb_default as default
};
//# sourceMappingURL=colord_plugins_hwb.js.map
